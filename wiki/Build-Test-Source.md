...
PlatformIO validation must also exercise EDP-Persistence as a framework-neutral package through `library.json`; this ensures pure ESP-IDF consumers can activate the library instead of treating it as Arduino-only packaging.
